...
export default function UI3D() {
  const { isPointerLocked, cursorHover } = useExperience();

  return (
    <div className="absolute d w-screen h-screen text-white ">
      {/* Pointer */}
      {isPointerLocked && (
        <div
      ...
      {/* Keyboard */}
      <div className="z-[9999] select-none flex flex-col p-4 absolute bottom-[2%] left-[2%] w-60 h-64 gradient-keyboard bg-gradient-to-b from-[#39393960] to-[#61616160] rounded-3xl backdrop-blur-xl custom-box-shadow">
